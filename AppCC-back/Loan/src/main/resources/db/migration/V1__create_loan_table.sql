CREATE TABLE IF NOT EXISTS `loan` (
                                      ...
                                      `status` VARCHAR(50),
                                      `approved` BOOLEAN,
                                      `signature_file_name` VARCHAR(255), -- Changed to VARCHAR assuming PNG
                                      `cin_cart_recto_file_name` VARCHAR(255), -- Changed column name
                                      `cin_cart_verso_file_name` VARCHAR(255), -- Changed column name
